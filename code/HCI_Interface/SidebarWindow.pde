class SidebarWindow extends PApplet {
  ...
  public void setup() {
    ...
    settings_button.AddComponent(new Button("", settings_button, "Settings", loadImage(path + "/images/settings_default.png"), loadImage(path + "/images/settings_click.png"), loadImage(path + "/images/settings_hover.png")));
